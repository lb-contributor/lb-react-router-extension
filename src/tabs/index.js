...
const Tabs = (function (_React$Component) {
  _inherits(Tabs, _React$Component)

  function Tabs() {
    _classCallCheck(this, Tabs)

    const _this = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).apply(this, arguments))
    ...
    _this.removeTab = function (targetKey, e) {
      ...
      const onEdit = _this.props.onEdit
      if (onEdit) {
  ...
  _createClass(Tabs, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        let tabPaneAnimated =
                    (typeof animated === 'undefined' ? 'undefined' : _typeof(animated)) === 'object' ? animated.tabPane : animated
        ...
        const cls = classNames(
          ...
          _defineProperty(_classNames, `${prefixCls}-card`, type.indexOf('card') >= 0),
          _defineProperty(_classNames, `${prefixCls}-${type}`, true),
          _defineProperty(_classNames, `${prefixCls}-no-animation`, !tabPaneAnimated),
          _classNames),
        )
        ...
        tabBarExtraContent = tabBarExtraContent
          ? React.createElement('div', { className: `${prefixCls}-extra-content` }, tabBarExtraContent)
          : null
        return React.createElement(
          ...
          _extends({}, this.props, {
            ...
            renderTabBar: function renderTabBar() {
              return React.createElement(
                TabBar,
                _extends({}, _this2.props, { tabBarExtraContent }),
              )
            },
