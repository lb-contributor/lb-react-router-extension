...
var _ScrollableInkTabBar = require('./rc-tabs/ScrollableInkTabBar');
...
var TabBar = function (_React$Component) {
  ...
  (0, _createClass3.default)(TabBar, [{
    ...
    value: function render() {
      ...
      var prevIcon = React.createElement('span', { className: prefixCls + '-tab-prev-icon' }, React.createElement(_icon2.default, { type: prevIconType, className: prefixCls + '-tab-prev-icon-target' }));
      var nextIcon = React.createElement('span', { className: prefixCls + '-tab-next-icon' }, React.createElement(_icon2.default, { type: nextIconType, className: prefixCls + '-tab-next-icon-target' }));
      var renderProps = (0, _extends3.default)({}, this.props, {
